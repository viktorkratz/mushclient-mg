...
function MStart(name, line, wildcards)
      if routeRecordMode == nil then
            ...
            if (selectedMode == nil) then
                  utils.msgbox(
                        "Es wurde kein Modus ausgew‰hlt, das Erfassen von Wegen benˆtigt aber die Angabe eines Erfassungsmodus. Geben Sie mmode ein, um den Modus zu setzen bzw. sp‰ter zu ‰ndern.",
